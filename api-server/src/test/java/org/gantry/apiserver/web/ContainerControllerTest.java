...
//        var dto = Container.builder().id("9123").applicationId(1L).status(ContainerStatus.PAUSED).build();
...
//        var dto = Container.builder().id("9123").applicationId(1L).status(ContainerStatus.REMOVING).build();
...
//        var dto = Container.builder().id("9123").applicationId(1L).status(ContainerStatus.RUNNING).build();
